...
// 					projectId, deploymentTargetId, dnsZone, deploymentNameSch, namespaceId, dataServiceNameDefaultAppConfigMap[supportedDataServices[i]],
// 					dataServiceNameImagesMap[supportedDataServices[i]], serviceType, dataServiceDefaultResourceTemplateIdMap[supportedDataServices[i]], storageTemplateId)
...
// 			num pods- 3, service-type - %v
// 			Resource template id - %v, storageTemplateId-%v`,
// 			projectId, deploymentTargetId, dnsZone, deploymentNameAdhoc, namespaceId, dataServiceNameDefaultAppConfigMap[supportedDataServices[i]],
// 			dataServiceNameImagesMap[supportedDataServices[i]], serviceType, dataServiceDefaultResourceTemplateIdMap[supportedDataServices[i]], storageTemplateId)
